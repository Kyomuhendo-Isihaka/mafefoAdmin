    ...
    <div class="container-fluid">
        <div class="container mt-5">
            <div class="card p-5 w-50 mx-auto">
                ...
                <form action="">
                    <input type="text" class="w-100 p-3 my-2" placeholder="Enter Username">
                    <input type="password" class="w-100 p-3 my-2" placeholder="Enter Password">
                    <button class="w-100 p-3 bg-primary my-2 text-white">Login</button>
                </form>
